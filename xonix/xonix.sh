...
declare -r KEY_HINT_MESSAGE="WSAD -- перемещение, X -- выход"
declare -r CONTINUE_MESSAGE="N -- начать новую игру, X -- выход"
...
declare -r LEVEL_MESSAGE="Уровень:"
declare -r SCORE_MESSAGE="Счёт:"
declare -r LIVES_MESSAGE="Жизни:"
declare -r REMAIN_MESSAGE="Осталось:"
